...
TMP101
    - config pins P9_21 & P9_22 to i2c, and properly connect a tmp101 to that i2c bus, pull the ADD0 pin to Ground.
    - run the shell script (temp_read.sh) on the BB to read the current temperature

Etch-a-sketch
    - config pins P9_21 & P9_22 to i2c, and properly connect a tmp101, with the ADD0 pin tied to ground, and the LED matrix to that i2c bus
